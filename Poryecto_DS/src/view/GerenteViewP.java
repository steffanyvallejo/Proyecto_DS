 ...
 * @author CltControl
 */
public class GerenteViewP extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(502, 328));
        setMinimumSize(new java.awt.Dimension(502, 328));
        setResizable(false);
        ...
        jLabel3.setText("MENU DE CONSULTAS");

        jButton3.setText("CONSULTAR TRANSACCION");

        jButton4.setText("CONSULTAR CLIENTE");

        jLabel4.setText("REPORTE");

        jButton5.setText("GENERAR REPORTE DIARIO");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GerenteViewP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
